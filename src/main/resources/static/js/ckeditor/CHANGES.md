...
* [#5217](https://dev.ckeditor.com/ticket/5217): Setting data (including switching between modes) creates a new undo snapshot. Besides that:
  * Introduced the [`editable.state`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editable.html#property-state) property.
...
* Included in [#10103](https://dev.ckeditor.com/ticket/10103):
  * Introduced the [`editor.state`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#property-state) property to make it easier to check the current state of the editor.
